...
<html lang="en">
    ...
    <head>
        ...
        <title>Order Confirmation - Cavernous Cupcakes</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="box">                    
                <%  if ("Success".equals(request.getAttribute("messageOrderFinalized"))) { %>
                        <div class="alert alert-success alert-dismissable">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Success!</strong> Your order was completed and is ready to be picked up.
                        </div>
                <% } %>
            </div>
            <!-- row -->
